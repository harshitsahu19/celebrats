            ...
            >
              ...
              <div className="evs-service-info">
                ...
                <div className="evs-price-chip">
                  <i className={service.priceIcon}></i> {service.price}
                </div>
                ...
                >
                  {service.exploreText} <i className="fas fa-arrow-right"></i>
                </a>
              </div>
            </div>
          ))}
        ...
        {serviceData.cta && (
          <div className="evs-cta-banner">
            ...
            <button className="evs-btn-primary" onClick={handleConsultClick}>
              <i className={serviceData.cta.buttonIcon}></i> {serviceData.cta.buttonText}
            </button>
          </div>
        )}
